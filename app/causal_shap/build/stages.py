...
def figures() -> None:
    """Render every app figure from frozen artifacts."""
    generated = 0
    ...
    def _save(fig, name: str, bundle_id: str) -> None:
        nonlocal generated
        bundle_path = BUNDLES_DIR / bundle_id / "stages" / name
        bundle_path.parent.mkdir(parents=True, exist_ok=True)
        fig.savefig(bundle_path, dpi=140, bbox_inches="tight", facecolor="white")
        plt.close(fig)
        generated += 1
    ...
    generated += 1
    print_status({"status": "figures", "count": generated})


def glossary() -> None:
    """Render the canonical glossary into the app-consumable JSON artifact."""
